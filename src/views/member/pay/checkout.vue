  ...
  <div class="xxm-pay-checkout-page">
    <div class="container">
      ...
      <div class="wrapper" v-if="order">
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <XxmButton @click="submitOrderFn" type="primary">提交订单</XxmButton>
        </div>
      </div>
    </div>
  </div>
