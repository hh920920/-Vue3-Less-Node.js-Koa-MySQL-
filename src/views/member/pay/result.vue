  ...
  <div class="xtx-pay-page">
    <div class="container">
      <XxmBread>
        ...
        <XxmBreadItem to="/cart">购物车</XxmBreadItem>
        <XxmBreadItem>支付结果</XxmBreadItem>
      </XxmBread>
      <!-- 支付结果 -->
      <div class="pay-result">
        ...
        <div class="btn">
          <XxmButton @click="$router.push('/member/order')" type="primary" style="margin-right:20px">查看订单</XxmButton>
          <XxmButton type="gray">进入首页</XxmButton>
        </div>
        <p class="alert">
          <span class="iconfont icon-tip"></span>
          温馨提示：小熊猫不会以订单异常、系统升级为由要求您点击任何网址链接进行退款操作，保护资产、谨慎操作。
        </p>
      </div>
    </div>
  </div>
