<template>
  <div class="xxm-pay-page">
    ...
    <!-- 支付提示对话框 -->
    <XxmDialog title="正在支付..." v-model:visible="visibleDialog">
      <div class="pay-wait">
...
import { baseURL } from '@/utils/test/requetest'
