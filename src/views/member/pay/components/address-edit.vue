<template>
  <XxmDialog :title="`${formData.id?'修改':'添加'}收货地址`" v-model:visible="visibleDialog">
    <!-- 表单 -->
    <div class="address-edit">
      <div class="xxm-form">
        <div class="xxm-form-item">
        ...
        <div class="xxm-form-item">
          ...
          <div class="field">
            <XxmCity :fullLocation="formData.fullLocation" @change="changeCity" placeholder="请选择所在地区"/>
          </div>
        </div>
    ...
    <!-- 按钮 -->
    <template #footer>
      <XxmButton @click="visibleDialog=false" type="gray" style="margin-right:20px">取消</XxmButton>
      <XxmButton @click="submit()" type="primary">确认</XxmButton>
    </template>
  </XxmDialog>
</template>
<script>
