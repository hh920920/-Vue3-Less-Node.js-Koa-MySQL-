<template>
  <div class="checkout-address">
    ...
    <div class="action">
      <XxmButton @click="openDialog()" class="btn">切换地址</XxmButton>
      <XxmButton @click="openAddressEdit({})" class="btn">添加地址</XxmButton>
    </div>
  </div>
  <!-- 对话框组件-切换收货地址 -->
  <XxmDialog title="切换收货地址" v-model:visible="visibleDialog">
    ...
    <template #footer>
      ...
      <XxmButton @click="confirmAddressFn" type="primary">确认</XxmButton>
    </template>
  </XxmDialog>
  <!-- 收货地址添加编辑组件 -->
